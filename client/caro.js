...
function runGame(){
    CELL_SIZE = Math.round(($('#main').height() - 40) / NCELL);
    $('#ChatBoxText')[0].style.height = ($('#main').height() - 161) + 'px';

    $('#GameLog')[0].style.height = ($('#main').height() - 30) + 'px';
    ...
    window.onresize = function(event) {
        CELL_SIZE = Math.round(($('#main').height() - 40) / NCELL);
    $('#ChatBoxText')[0].style.height = ($('#main').height() - 141) + 'px';
    $('#GameLog')[0].style.height = ($('#main').height() - 30) + 'px';
